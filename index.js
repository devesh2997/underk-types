module.exports = {
    ...
    ORDER_PRODUCT_STATUS_INIT: 'init',
    ORDER_PRODUCT_STATUS_CANCELLED: 'cancelled',
    ORDER_PRODUCT_STATUS_USER_CANCELLED: 'usercancelled',
    ORDER_PRODUCT_STATUS_ACCEPTED: 'accepted',
    ORDER_PRODUCT_STATUS_IN_PROGRESS: 'inprogress',
    ORDER_PRODUCT_STATUS_RETURN_IN_PROGRESS: 'returninprogress',
    ORDER_PRODUCT_STATUS_CANCELLED_RETURN_IN_PROGRESS: 'cancelledreturninprogress',
    ORDER_PRODUCT_STATUS_FULFILLED: 'fulfilled',
    ORDER_PRODUCT_STATUS_CLOSED: 'closed',
